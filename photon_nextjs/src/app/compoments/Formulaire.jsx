                    ...
                    <div className="right-side">
                        ...
                        <div className="input-box">
                            ...
                            <div className="w-40 grid grid-cols-1 gap-4">
                                <Button id="Submit" type="submit" className="bg-blue-500 text-white p-2.5 px-5 me-2 rounded-lg hover:bg-blue-300">
                                    Submit
                                </Button>

                                <button id="Loading" className="py-2.5 px-5 me-2 text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 inline-flex items-center" disabled>
